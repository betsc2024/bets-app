...
const ReportingBossEvaluation = ({ userId, companyId, bankId }) => {
  ...
  const generateChartData = (data, cumSelf, cumBoss) => {
    try {
      if (data && data.length > 0) {
        ...
        const allVals = [...selfScoreData, ...bossScoreData];
